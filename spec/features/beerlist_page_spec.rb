...
describe "Beerlist page" do
  ...
  it "should sort list by style", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(1) a#style').click
  ...
  it "should sort list by brewery", :js => true do
    visit beerlist_path
    find('table').find('tr:nth-child(1) a#brewery').click
